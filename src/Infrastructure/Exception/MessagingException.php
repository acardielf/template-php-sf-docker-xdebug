...
final class MessagingException extends InfrastructureException
{
     ...
     * @param Throwable|null $previous     The original transport exception
     */
    public static function failedToDispatch(string $messageClass, ?Throwable $previous = null): self
    {
