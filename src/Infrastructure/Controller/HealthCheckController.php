...
final class HealthCheckController extends AbstractController
{
    ...
    #[OA\Get(path: '/api/health', description: 'Returns the current health status of the application. Use this endpoint for liveness and readiness probes.', summary: 'Application health check', responses: [
        new OA\Response(
